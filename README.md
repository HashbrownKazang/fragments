...
Forked from Fragments by E2B and then remixxed
...
Powered by the [E2B SDK](https://github.com/e2b-dev/e2b).
...
- Uses the [E2B SDK](https://github.com/e2b-dev/e2b) by [E2B](https://e2b.dev) to securely execute code generated by AI.
- Streaming in the UI.
